...
const CoinPage = () => {
  ...
  const params = useParams();  //Child routes inherit all params from their parent routes.
  // console.log(params); 

  const url = `https://api.coingecko.com/api/v3/coins/${params.coinId}?localization=false&sparkline=true`;  
  //useParams used to give the page of the coin we clicked. It also accesses <Route path=':coinId'/> from our App.jsx.
  ...
  return (
    <div className='rounded-div my-12 py-8'>
      ...
      <div className='py-4'>
        ...
        {/* just this 'coin.description ? coin.description.en' returns a html file which isnt readable , so to make it readable dompurify is used */}
      </div>
    </div>
  );
};
